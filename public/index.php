...
<body>
    ...
    <div class="PopUpConteiner hidden" id="PopUp">
        ...
        <form action="sendMail.php" method="post">
            ...
            <button disabled type="submit" name="SubmitButton" id ="SubmitButton" class="SubmitButton disablePhone disableEmail" onclick="PopUp('PopUp')">
